...
public class CassandraUtils {
    ...
    private String cassandraHost = "cassandra-quick-test.cassandra.cosmos.azure.com";
    private int cassandraPort = 10350;
    private String cassandraUsername = "cassandra-quick-test";
    private String cassandraPassword = "m0uNLrBEEoBNtwSwJ9nO84Bbu3e9sjvWaW9p9UGBmKZp8AH6dNUZ1BVKWia4kELiceeNZceOxon2ypcia8QYyw==";
